...
public class BattleMain : BattleTimeline
{
    ...
    {
        PlayableStop();
        messageText.DisplayBattleMessage(battleManager.BattleMessage);
    }
    ...
    {
        PlayableStop();
        messageText.Activate();
        messageText.DisplayBattleMessage(battleManager.ResultMessage);
    }
    ...
    public void TurnResult()
    {
        ...
        else
        {
            if (bm.Defender.hp <= 0)
            {
                ...
                messageText.DisplayBattleMessage(bm.BattleMessage);
            }
        }
    }
